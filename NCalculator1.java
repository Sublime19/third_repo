...
public class NCalculator1 {
  ...
  public static void main(String args[])
  {
	  ...
	  JFrame frame = new JFrame("Calculator");
	   ...
	   Font f = new Font("Century",Font.PLAIN,20);
	   Font f1 = new Font("Times New Roman",Font.PLAIN,45);
	   f2 = new Font("Times New Roman",Font.PLAIN,25);

	   text.setBounds(1,0,289,100);
	   text.setDisabledTextColor(Color.ORANGE);
	   ...
	   frame.setIconImage(icon.getImage());
		...
		btno1.setForeground(Color.WHITE);
		btno2.setForeground(Color.WHITE);
		btno3.setForeground(Color.WHITE);
		btno4.setForeground(Color.WHITE);
		btno5.setForeground(Color.WHITE);
